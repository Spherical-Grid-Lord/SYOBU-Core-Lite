...
| リポジトリ名 | 役割 | レイヤー |
| :--- | :--- | :--- |
| [SYOBU-Core-Lite](OLD_README.md) | Human-AI 共通言語層 | 言語・ドキュメント |
| [A.I.ss.md](AIss.dm) | 構造研究と感覚合成 | 身体・感覚 |
...
|[Reality-Grinding.md](./Reality-Grinding.html)| 月下供酌| *中核実行プロトコル* |(https://spherical-grid-lord.github.io/SYOBU-Core-Lite/Reality-Grinding.html)
